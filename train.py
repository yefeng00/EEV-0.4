...
parser.add_argument('--max_step', default = 3000000, type = int)
parser.add_argument('--batch_size', default = 4, type = int)
parser.add_argument('--decay_step', default = 1000000, type = int)
parser.add_argument('--print_step', default = 300, type = int)
...
if args.metric == "mse":
    lambda_to_qp_dict = {2048: 22, 1024: 27, 512: 32, 256: 37}
else:
